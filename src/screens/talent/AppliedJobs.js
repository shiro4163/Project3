  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.screen}>
        ...
        <Text style={{...styles.caption, justifyContent: "flex-end"}}>2 Applied Jobs.</Text>
        </View>  
              ...
              justifyContent: "space-between"}}>
                <View style={{width: 220, marginBottom: 7}}>
                  <Text style={{...styles.title2 , color: "#14a800"}}>
                    Hair and Make Up for my wedding</Text>
                    <Text style={{...styles.title2 , color: "#555"}}>Baliuag Bulacan</Text>
                    </View>
    ...
    paddingHorizontal: 10, paddingVertical: 10, marginTop: 10}}>
        ...
        <View style={{flexDirection: "column"}}>
              ...
              justifyContent: "space-between"}}>
                <View style={{width: 220, marginBottom: 7}}>
                  <Text style={{...styles.title2 , color: "#14a800"}}>
                    Extra Mobile Dev for a project</Text>
                    <Text style={{...styles.title2 , color: "#555"}}>Pulilan Bulacan</Text>
                    </View>
                  <View style={{flexDirection: "row", alignItems: "flex-end"}}>
                    <TouchableOpacity
                        activeOpacity={0.5}
