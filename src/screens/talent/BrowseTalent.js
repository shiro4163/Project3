  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.screen}>
        ...
        <Text style={{...styles.caption, justifyContent: "flex-end"}}>2,000 Freelancers found.</Text>
        </View>  
    ...
    paddingHorizontal: 10, paddingVertical: 10, marginBottom: 10}}>
            <View style={{ flexDirection: "row", marginBottom: 15 }}>
                ...
                <View style={{ marginLeft: 15, flexDirection: "column" }}>
                    ...
                    <Text style={{...styles.title2 , color: "#14a800"}}>Dylan Nate</Text>
    ...
    paddingHorizontal: 10, paddingVertical: 10, marginBottom: 10}}>
            <View style={{ flexDirection: "row", marginBottom: 15 }}>
                ...
                <View style={{ marginLeft: 15, flexDirection: "column" }}>
                    ...
                    <Text style={{...styles.title2 , color: "#14a800"}}>Nora Tapsin</Text>
                    <Text style={styles.caption2}>Baliuag Bulacan</Text>
                    <View style={{flexDirection: "row"}}>
                        <FontAwesome name="star" size={14} color="#14a800" style={{marginRight: 5}}/>
                        <FontAwesome name="star" size={14} color="#14a800" style={{marginRight: 5}}/>
    ...
    paddingHorizontal: 10, paddingVertical: 10, marginBottom: 10}}>
            <View style={{ flexDirection: "row", marginBottom: 15 }}>
                ...
                <View style={{ marginLeft: 15, flexDirection: "column" }}>
                    ...
                    <Text style={{...styles.title2 , color: "#14a800"}}>Jen Rafer</Text>
                    <Text style={styles.caption2}>Baliuag Bulacan</Text>
                    <View style={{flexDirection: "row"}}>
                        <FontAwesome name="star" size={14} color="#14a800" style={{marginRight: 5}}/>
                        <FontAwesome name="star" size={14} color="#14a800" style={{marginRight: 5}}/>
    ...
    paddingHorizontal: 10, paddingVertical: 10, marginBottom: 10}}>
            <View style={{ flexDirection: "row", marginBottom: 15 }}>
                ...
                <View style={{ marginLeft: 15, flexDirection: "column" }}>
                    ...
                    <Text style={{...styles.title2 , color: "#14a800"}}>Xian Santos</Text>
                    <Text style={styles.caption2}>Baliuag Bulacan</Text>
                    <View style={{flexDirection: "row"}}>
                        <FontAwesome name="star" size={14} color="#14a800" style={{marginRight: 5}}/>
                        <FontAwesome name="star" size={14} color="#14a800" style={{marginRight: 5}}/>
